...
New free version linking controlled by top-level configuration JSON, using the following schema:

{"data":[{ "account":"BIGFIC-200", "default":"vid", "hasCustomAssets":false, "excludeApps":"", "excludeSKUs":"", "navbarAltColor":"#6600FF", "showFilterList":true, "showClearButton":true, "showReleaseList":true, "appFilterList":"", "qtrFilterList":"", "bolShowFreeLink":true, "strFreeText":"This is placeholder text", "strFreeLink":"http://www.yahoo.com", "strFreeBtnClr":"#8034EB", "webconfig":[{ }]

The JSON attribute for bolShowFreeLink enables the display of the new portion in each enabled tab, strFreeText sets the text of the button, strFreeLink sets the URL of its destination web page, and strFreeBtnClr sets the hexidecimal color of the button.  A target="_blank" attribute has been added to each button's HTML.
